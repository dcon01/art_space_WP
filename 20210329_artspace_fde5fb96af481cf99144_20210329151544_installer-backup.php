...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20210329_artspace_fde5fb96af481cf99144_20210329151544_archive.zip';
	const ARCHIVE_SIZE		 = '73531188';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'fde5fb9-29151544';
    const SECONDARY_PACKAGE_HASH = '47f7d2f-29151544';
	const VERSION			 = '1.4.0';
